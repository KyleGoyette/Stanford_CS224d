...
def softmax(x):
  ...
  ### YOUR CODE HERE
  print(tf.shape(x))
  max_vals=tf.reduce_max(x,reduction_indices=1,keep_dims=True)
  x-=max_vals
  print(tf.shape(x))
...
def cross_entropy_loss(y, yhat):
  ...
  """
  ### YOUR CODE HERE
  y=tf.to_float(y,name='y_float')
  probs_mult=(y*tf.log(yhat))
  out=-tf.reduce_sum(probs_mult,reduction_indices=[0,1])
  ### END YOUR CODE
  return out
